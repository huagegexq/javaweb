...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=/xiaomi/pay/alipay.trade.page.pay.jsp method=post
			target="_blank">
...
<script language="javascript">
	...
	/* function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "测试111";
		document.getElementById("WIDtotal_amount").value = "10.10";
	}
	GetDateNow(); */
</script>
</html>