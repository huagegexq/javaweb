...
<body style="background:#f0f9fd;">
    ...
    <span><img src="images/leftico01.png" /></span>小米功能
        ...
        <li class="active"><cite></cite><a href="${pageContext.request.contextPath}/user?method=findUlistByPage&pageNumber=1" target="rightFrame">用户管理</a><i></i></li>
        ...
        <li><cite></cite><a href="${pageContext.request.contextPath}/product?method=findPlistByPage&pageNumber=1" target="rightFrame">商品管理</a><i></i></li>
		</a><i></i></li>
