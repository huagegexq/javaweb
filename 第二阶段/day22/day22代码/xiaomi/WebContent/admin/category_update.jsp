...
<body>
    ...
    <form action="" method="post">
	    ...
	    <ul class="forminfo">
		    <li><label>类别名称</label><input name="cname" type="text" value="" class="dfinput" /><i>类别名称不能超过30个字符</i></li>
		    <li><label>是否启用</label>
			    <cite>
				    <input name="status" type="radio" value="1" <c:if test="">checked</c:if>/>是&nbsp;&nbsp;&nbsp;&nbsp;
				    	
				    <input name="status" type="radio" value="0" <c:if test="">checked</c:if>/>否
			    </cite>
		    </li>
